...
const initialState=():JourneyState=>({activeWorldId:'misty-journey',...initialProgress(worldRepository.get('misty-journey')),welcomed:false,sessionDistance:0,progressByWorld:{}})
...
export const useJourneyStore=defineStore('journey',()=>{
  ...
  return{state,world,chapter,nextCheckpoint,unlockedCheckpoints,progress,sessionDistance,lifetimeDistance,allUnlockedNodeCount,allNodeCount,pendingSettlement,activeEvent,displayDistance,isAnimating,hydrate,persist,setWelcomed,prepareSettlement,play,continueJourney,skipJourney,reset,selectWorld,checkpointById,chapterById}
})
