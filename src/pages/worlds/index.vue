...
<template><view class="safe-page worlds page-enter" :class="localeClass">
  ...
  <view class="list"><view v-for="world in lockedWorlds" :key="world.id" class="expedition-card locked-card pressable" @click="locked">
